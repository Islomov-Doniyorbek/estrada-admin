...
<div className='admin_menu_list'>
  ...
  <div onClick={() => navigate('/Adminpanel/Adminqoshish')} className='admin_menu_card'>
 ...
 <div onClick={() => navigate('/Adminpanel/Postqoshish')} className='admin_menu_card'>
  ...
  <div onClick={() => navigate('/Adminpanel/Ilmiyfaoliyatqoshish')} className='admin_menu_card'>
  ...
  <div onClick={() => navigate('/Adminpanel/TalimQoshish')} className='admin_menu_card'>
    ...
    <div onClick={() => navigate('/Adminpanel/Qabul')} className='admin_menu_card'>
    ...
    <div className='none_media'>
      ...
      <p>Ma'lumot qo‘shish</p>
        ...
        <div onClick={() => navigate('/Adminpanel/Sturture')} className='admin_menu_card'>
  ...
  <div onClick={() => navigate('/Adminpanel/UserPosts')} className='admin_menu_card'>
    ...
    <div onClick={() => navigate('/Adminpanel/Alloffers')} className='admin_menu_card'>
    <span><TfiEmail /></span>
    <div className='none_media'>
    ...
    <div onClick={() => navigate('/Adminpanel/Application')} className='admin_menu_card'>
